...
namespace Calculator
{
    public partial class frmCalculator : Form
    {
        ...
        private void button_negativeClick(object sender, EventArgs e)
        {
            ...
            {
                before = input.Substring(0, lastOperatorIndex + 1);
                number = input.Substring(lastOperatorIndex + 1);
            }
            else
            {
                number = input;
